...
LOCAL_SETTINGS_PATH = os.path.join(BASE_DIR, './openkamer/settings/local_settings.py')
LOCAL_SETTINGS_EXAMPLE_PATH = os.path.join(BASE_DIR, './openkamer/settings/local_settings_example.py')
